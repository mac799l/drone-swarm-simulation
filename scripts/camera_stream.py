"""
    Filename: camera_stream.py
    Author: Cameron Lira
    Date: 2025-07-14
    Version: 1.0
    Project: Drone Swarm Control Using SITL and Gazebo
    Description: This script displays a video stream from the camera of a simulated drone in Gazebo.
"""
...
def main():
    ...
    # Print information to verify Gstreamer is enabled.
